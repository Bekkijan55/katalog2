        ...
        <template v-if="breakpoint != 'md'">
          ...
          <div class="bookmark-container">
            <!-- <feather-icon
              ...
              @click="showBookmarkPagesDropdown = !showBookmarkPagesDropdown"
            />-->
            <div
        ...
        <vs-dropdown vs-custom-content vs-trigger-click>
          ...
          <vs-dropdown-menu class="w-48 i18n-dropdown">
            ...
            <vs-dropdown-item @click="updateLocale('ru')">
              <img class="h-4 w-5 mr-1" src="@/assets/images/flags/ru.png" alt="fr"> &nbsp;Русский
            </vs-dropdown-item>
            <vs-dropdown-item @click="updateLocale('uz')">
              <img class="h-4 w-5 mr-1" src="@/assets/images/flags/uz.png" alt="de"> &nbsp;O'zbekcha
            </vs-dropdown-item>
          </vs-dropdown-menu>
        </vs-dropdown>
...
export default {
  ...
  computed: {
    ...
    getCurrentLocaleData() {
      ...
      else if (locale == "uz") return { flag: "uz", lang: "O'zbek" };
    },
    data() {
