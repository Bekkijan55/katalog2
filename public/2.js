...
/* harmony import */ var D_project_OSPanel_domains_erp_loc_node_modules_babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime-corejs2/core-js/get-iterator */ "./node_modules/@babel/runtime-corejs2/core-js/get-iterator.js");
/* harmony import */ var D_project_OSPanel_domains_erp_loc_node_modules_babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(D_project_OSPanel_domains_erp_loc_node_modules_babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var D_project_OSPanel_domains_erp_loc_node_modules_babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime-corejs2/core-js/object/assign */ "./node_modules/@babel/runtime-corejs2/core-js/object/assign.js");
/* harmony import */ var D_project_OSPanel_domains_erp_loc_node_modules_babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(D_project_OSPanel_domains_erp_loc_node_modules_babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _api_users__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../api/users */ "./resources/api/users.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getRoles: function getRoles() {
      ...
      Object(_api_users__WEBPACK_IMPORTED_MODULE_6__["getRole"])().then(function (response) {
    ...
    usersGet: function usersGet() {
      ...
      Object(_api_users__WEBPACK_IMPORTED_MODULE_6__["getUsers"])().then(function (response) {
    ...
    openDialog: function openDialog(row) {
      this.restTemp();
      this.temp = D_project_OSPanel_domains_erp_loc_node_modules_babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, row); // copy obj
      ...
      if (this.temp.roles.length) {
        ...
        try {
          for (var _iterator = D_project_OSPanel_domains_erp_loc_node_modules_babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_0___default()(this.temp.roles), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var val = _step.value;
            var r = [];
            r.push(val.id);
            this.temp.roles = r;
    ...
    editDate: function editDate() {
      ...
      Object(_api_users__WEBPACK_IMPORTED_MODULE_6__["updateUser"])(this.temp, this.temp.id).then(function (response) {
        _this3.acceptAlert();
      });
    },
    // dialogs info notify
...
/*!********************************!*\
  !*** ./resources/api/users.js ***!
  \********************************/
/*! exports provided: getUsers, getUserId, createUser, updateUser, getRole */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
