...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchFiles: function fetchFiles() {
      ...
      Object(_api_katalog__WEBPACK_IMPORTED_MODULE_0__["getFiles"])(this.id).then(function (res) {
    ...
    checkFile: function checkFile(e) {
      ...
      Object(read_excel_file__WEBPACK_IMPORTED_MODULE_1__["default"])(e.target.files[0]).then(function (rows) {
    ...
    sendFile: function sendFile() {
      ...
      console.log(this.allrows);
      Object(_api_katalog__WEBPACK_IMPORTED_MODULE_0__["sendExcel"])(this.allrows).then(function (res) {
        console.log(res);
